    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item active"><a class="nav-link active" href="#tab_users_active" role="tab"  data-toggle="tab">Dízimos</a></li>
            <li class="nav-item"><a class="nav-link" href="#tab_users_inactive" role="tab"  data-toggle="tab">Ofertas</a></li>
        </ul>
                ...
                <div class="modal-header">
                    ...
                    {!! Form::open(['class' =>'user', 'id' => 'launch_form']) !!}
                        ...
                        <div class="modal-body">
                            ...
                            @include('templates.forms.input',['input' => 'text','value' => '0', 'class' => 'd-none', 'attributes' => [ 'name' => 'idtb_operation', 'hidden', 'id' => 'idtb_operation']])

                            @include('templates.forms.input',['input' => 'text','value' => '0', 'class' => 'd-none', 'attributes' => [ 'name' => 'idtb_type_launch', 'hidden', 'id' => 'idtb_type_launch']])

                            @include('templates.forms.input',['input' => 'text','value' => '0', 'class' => 'd-none', 'attributes' => [ 'name' => 'idtb_base', 'hidden', 'id' => 'idtb_base']])

                            @include('templates.forms.input',['input' => 'text','value' => '0', 'class' => 'd-none', 'attributes' => [ 'name' => 'idtb_closing', 'hidden', 'id' => 'idtb_closing']])
                            <!-- \ Imputs hidden -->
                            ...
                            @include('templates.forms.select',['select' => 'mes', 'label' => 'Mês Referência', 'data' => ['1' => 'Janeiro', '2' => 'Fevereiro'],'attributes' => ['placeholder' => 'Mês Referência', 'class' => 'form-control form-control-user', 'id' => 'reference_month', 'name' => 'reference_month']])
